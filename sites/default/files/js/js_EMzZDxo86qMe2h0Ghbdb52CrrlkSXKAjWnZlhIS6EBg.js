  ...
  var init = function () {
    ...
    $(window).scroll(function() {
      if( $(this).scrollTop() > 300 ) {
        ...
        $("[data-page=front]").removeClass('is-front');
      } else {
        $(".o-header").removeClass('sticky');
        $("[data-page=front]").addClass('is-front');
      }
    });

    //Scroll to
    $('.o-header__services a').click(function(e) {
      e.preventDefault();

      var $this = $(this);
      var $url = $this.attr('href').replace('/services', '');

      $('html, body').animate({scrollTop: $($url).offset().top - 200}, 800);
    });

    $('.o-header__btn a').click(function(e) {
      e.preventDefault();
    ...
    $('.o-header.internal .o-header__menu__item #link_providers').click(function(e) {
      e.preventDefault();
    ...
    $(window).on("load", function () {
      ...
      $('html,body').animate({scrollTop: $('#' + urlHash).offset().top - 100}, 800);
    });
